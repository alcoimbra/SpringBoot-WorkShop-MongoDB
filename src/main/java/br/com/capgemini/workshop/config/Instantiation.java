...
import br.com.capgemini.workshop.dto.AuthorDTO;
import br.com.capgemini.workshop.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO comment3 = new CommentDTO("Tenha um ótimo Último Dia!", sdf.parse("23/03/2018"), new AuthorDTO(alex));
